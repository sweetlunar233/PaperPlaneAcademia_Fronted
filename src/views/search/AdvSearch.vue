<template>
    <div>
      ...
      <el-main>
        ...
        <el-col :span="6">
          <el-card :style="{ backgroundColor: '#f0f8ff', borderRadius: '8px', padding: '20px', border: '1px solid #dcdcdc' }">
    <h3>Learn More</h3>
    <div style="height: 1px; background-color: #dcdfe6; margin-bottom: 8px;margin-top: 8px;"></div>
    <a 
